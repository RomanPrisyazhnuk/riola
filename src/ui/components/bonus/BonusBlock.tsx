        ...
        return (
            <section className='relative rounded-lg  min-h-[344px] gap-6  overflow-hidden flex-wrap mt-6'>
                ...
                <div className='relative z-30 p-6 mt-[300px] sm:mt-0'>
                    <p className='text-[32px] sm:text-[48px] font-bold text-textColor'>Войди и сэкономь </p>
                    <p className='text-[20px] sm:text-[24px] text-textColor max-w-[578px] mb-6'>Вы можете сэкономить от 10% на любую экскурсию, когда зарегистрируете аккаунт</p>
                    <UserMenuContainer/>
                </div>
